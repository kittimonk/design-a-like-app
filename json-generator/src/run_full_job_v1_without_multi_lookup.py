...
Steps:
  ...
  6) build_dt_view_from_model_v11c.py → dt_<malcode>_<base>.json
...
def main():
    ...
    dt_view_v11c      = scripts_dir / "build_dt_view_from_model_v11c.py"
    build_job_v1      = scripts_dir / "build_job_json_v1.py"
    load_enrich_v2    = scripts_dir / "build_load_enrich_from_dt_v2.py"
    combined_v4       = scripts_dir / "build_combined_job_v4.py"
