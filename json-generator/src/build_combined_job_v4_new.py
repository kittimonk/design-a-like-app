...
def trim_data_sourcing_to_keep_modules_open(ds_text: str) -> str:
    ...
    Updated to handle both `}` and `},` as valid closing braces.
    """
    ...
    # Index of the brace that closes data_sourcing_process (3rd from the end)
...
def main():
    ...
    # 3) Infer malcode & target table name
